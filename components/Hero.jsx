                    ...
                    <div className="lg:col-span-7 text-center lg:text-left">
                        <FadeIn>
                            ...
                            <h1 className="text-4xl lg:text-6xl font-bold tracking-tight text-white mb-6 leading-tight">
                                Hi, I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">Aishwarya</span><br />
                                Madapati
                            </h1>

                            <p className="text-lg text-slate-400 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
                                Cybersecurity & IAM professional with hands-on experience in <strong className="text-purple-300">ForgeRock, PingFederate, OAuth 2.0, and OIDC</strong>.
                        ...
                        <FadeIn delay={200}>
                            ...
                            <div className="absolute -bottom-6 -left-6 bg-slate-900/90 backdrop-blur-md p-4 rounded-xl shadow-xl border border-white/10 z-20">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-xs text-slate-400 uppercase font-bold">Security Focus</p>
                                        <p className="text-sm font-semibold text-white">IAM & Compliance</p>
                                    </div>
                                </div>
                            </div>
                        </FadeIn>
